...
**Objective:** This project quantifies the divergence between nominal and inflation-adjusted economic indicators by constructing a CPI-based deflation pipeline and applying it to U.S. wage and price data.
